...
export default function FAQPage() {
  const general = [
    ...
    {
      question: 'Can I use these challenges within my own free or commercial content/tutorials/projects?',
  ...
  const account = [
    {
      question: 'Is there any way to sign-up other than GitHub?',
  ...
  const subscription = [
    ...
    {
      question: 'I\'m on the monthly subscription option and would like to upgrade to yearly. How can I do this?',
    ...
    {
      question: 'Why are there credits limits on the monthly subscription?',
    ...
    {
      question: 'Can I buy a subscription as a gift for someone else?',
  ...
  const challenge = [
    ...
    {
      question: 'What is the difference between the desktop-design, mobile-design, and desktop-preview images in my starter code?',
  ...
  const solution = [
    ...
    {
      question: 'How do I edit my solution?',
    ...
    {
      question: 'How do I delete my solution?',
    ...
    {
      question: 'How do I generate a new solution screenshot?',
    ...
    {
      question: 'Why does my solution screenshot look different to the live version?',
  ...
  const licensing = [
    {
      question: 'Can I stream myself completing Frontend Mentor challenges?',
    ...
    {
      question: 'Can I use Frontend Mentor challenges within my free course/tutorial?',
    ...
    {
      question: 'I want to use Frontend Mentor challenges in a commercial course/tutorial/project. Is this possible?',
